...
import ar.edu.undef.fie.productApp.utils.KeycloakProvider;
...
public class KeycloakService implements IKeycloakService {
     ...
     * @return String
     */
    public String createUser(@NonNull UserRequest userDTO) {
     ...
     * @return void
     */
    public void updateUser(String userId, @NonNull UserRequest userDTO) {
...
public String getEmailFromToken(Principal principal) {
    if (principal instanceof org.springframework.security.oauth2.server.resource.authentication.JwtAuthenticationToken) {
        ...
        log.error("Principal is an instance of: " + principal.getClass().getName());
        return null;
    }
}
